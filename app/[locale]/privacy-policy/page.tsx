          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-green-700">
                The Babel Edit is committed to protecting your privacy and personal information. We only collect 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-3 text-slate-600">
                <p><strong>Business Name:</strong> The Babel Edit</p>
                <p><strong>Website:</strong> www.thebabeledit.com</p>
                <p><strong>Contact:</strong> support@babeledit.com</p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="mt-6 bg-red-50 p-4 rounded-lg border border-red-200">
            ...
            <p className="text-red-700 text-sm">
              The Babel Edit does not sell, rent, or trade your personal information to third parties for 
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="mt-6 bg-blue-50 p-6 rounded-lg">
            ...
            <p className="text-blue-700 text-sm mb-4">
              To exercise any of these privacy rights, please contact us at support@babeledit.com with your 
              request. We will respond within 30 days and may need to verify your identity for security purposes.
            </p>
            <div className="flex items-center">
              <Mail className="w-5 h-5 text-blue-600 mr-2" />
              <a href="mailto:support@babeledit.com" className="text-blue-600 hover:text-blue-800 font-medium">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3 text-slate-600">
                <p>
                  The Babel Edit is based in the United States. If you're shopping from outside the US, 
