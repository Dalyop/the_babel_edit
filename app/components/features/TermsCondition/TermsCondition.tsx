        ...
        <div className="prose prose-neutral max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-neutral-700 leading-relaxed">
              <p>
                These are the terms and conditions under which The Babel Edit ("we", "us", or "our") supplies products ("Products") listed on our website www.thebabeledit.com ("Our Site") to you.
              </p>
              <p>
            ...
            <div className="space-y-4 text-neutral-900 leading-relaxed">
              ...
              <div className="bg-neutral-50 p-4 rounded-lg">
                <p className="flex items-center gap-2">
                  ...
                  <a href="mailto:support@babeledit.com" className="text-neutral-900 hover:text-neutral-600 transition-colors">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-neutral-700 leading-relaxed">
              <p>
                All content on Our Site, including logos, images, and text, is the property of The Babel Edit and may not be used without permission.
              </p>
            </div>
          </section>
        ...
        <div className="mt-16 pt-8 border-t border-neutral-200">
          <div className="text-center">
            <p className="text-neutral-600 italic text-lg">
              Thank you for supporting The Babel Edit — where style tells a story.
            </p>
          </div>
        </div>
      </div>
